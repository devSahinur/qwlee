...
const sendEmailVerification = async (to, otp) => {
 ...
 <body style="background-color: #f3f4f6; padding: 2rem; font-family: Arial, sans-serif; color: #333;">
  <div style="max-width: 30rem; margin: 0 auto; background-color: #ffffff; padding: 2rem; border-radius: 0.75rem; box-shadow: 0 10px 20px rgba(0, 0, 0, 0.15); text-align: center;">
    <img src="https://i.ibb.co/99DDJ34/Property-1-Logo-Mark-1.png" alt="Qwlee Logo" style="max-width: 10rem; margin-bottom: 1.5rem;">
    <h1 style="font-size: 1.75rem; font-weight: 700; margin-bottom: 1rem; color: #1f2937;">Welcome to Qwlee</h1>
    <p style="color: #4b5563; margin-bottom: 1.5rem;">Thank you for joining Qwlee! Your account is almost ready.</p>
    ...
    <p style="color: #6b7280; font-size: 0.875rem;">Thanks, The Qwlee Team</p>
